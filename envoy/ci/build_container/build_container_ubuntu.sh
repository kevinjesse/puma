...
apt-get update
apt-get install -y wget software-properties-common make cmake git python python-dev python-pip \
  bc libtool automake zip time golang g++ gdb strace gfortran
